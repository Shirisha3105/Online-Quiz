...
function matchpass(){  
var firstpassword=document.f1.currentpassword.value;  
...
<br>
   ...
   <!-- <caption>CHANGE YOUR PASSWORD HERE</caption> --> 
    ...
    <tr>
 <td align="right"><label><b>Current Password</style> </b></label>: </td><td><input type = "password" placeholder = "Current password" name = "currentpassword" oninvalid="this.setCustomValidity('Please Enter current password')" oninput="setCustomValidity('')" required></td>
   </tr><tr>     
